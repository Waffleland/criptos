...
include("conectarmysql.php");
        ...
        if ($error!=""){
            ...
            if ($_POST['registro']=='1')
            {
                ...
                $query="SELECT id FROM usuarios WHERE mail='".mysqli_real_escape_string($enlace,$_POST['mail'])."'LIMIT 1";
                $result = mysqli_query($enlace,$query);
                if (mysqli_num_rows($result)>0){
                    $error="Email ya registrado";
                }
                else {
                    $query="INSERT INTO usuarios (mail,password) VALUES ('".mysqli_real_escape_string($enlace,$_POST['mail'])."','".mysqli_real_escape_string($enlace,$_POST['password'])."')";
                ...
                $query="SELECT * FROM usuarios WHERE mail='".mysqli_real_escape_string($enlace,$_POST['mail'])."'";
                $result=mysqli_query($enlace,$query);
...
<?php include("header.php"); ?>
        <div class="container">
                <h1 class="titulo">Comprá y/o vendé tus criptomonedas</h1>
                <p><strong>Conectá con otros compradores y vendedores más facilmente</strong></p>
        <div id="error">
            <?php echo $error; ?>
        </div>
        <form method="POST" id="formularioRegistro">
            ...
            <div class="form-group">
                <input class="form-control" type="mail" name="mail" placeholder="Tu email">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="btn btn-warning" type="submit" name="submit" value="Registrate!">
            </div>
        ...
        <div class="form-group">
            ...
            <input class="btn btn-warning"  type="submit" name="submit" value="Inicia sesión">
        </div>
